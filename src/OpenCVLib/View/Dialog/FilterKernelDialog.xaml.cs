...
[ObservableObject]
[KeyedInject(typeof(IContentControl), nameof(FilterKernelDialog), Lifecycle.Singleton)]
public partial class FilterKernelDialog : IContentControl
{
    public FilterKernelDialog()
    {
        DataContext = this;
        InitializeComponent();
    }
